...
var startServerCmd = &cobra.Command{
	Use:   "startServer",
	Short: "Starts the application as a HTTP server",
	Long:  `Starts the application as a HTTP server. User has to provide 'config.json' file for server startup details. Server will start in attached mode in terminal.`,
